...
from model.piece import ANIMATION_IDLE, ANIMATION_JUMP, ANIMATION_LONG_REST, ANIMATION_MOVE, ANIMATION_SHORT_REST, CAPTURED
...
def test_sprite_path_maps_idle_state_to_the_idle_folder():
    ...
    path = animator.sprite_path("p1", "KW", ANIMATION_IDLE)
...
def test_sprite_path_maps_moving_state_to_the_move_folder():
    ...
    path = animator.sprite_path("p1", "KW", ANIMATION_MOVE)
...
def test_sprite_path_maps_airborne_state_to_the_jump_folder():
    ...
    path = animator.sprite_path("p1", "KW", ANIMATION_JUMP)
...
def test_sprite_path_maps_short_rest_state_to_the_short_rest_folder():
    ...
    path = animator.sprite_path("p1", "KW", ANIMATION_SHORT_REST)
...
def test_sprite_path_maps_long_rest_state_to_the_long_rest_folder():
    ...
    path = animator.sprite_path("p1", "KW", ANIMATION_LONG_REST)
...
def test_frame_advances_as_time_passes_in_a_looping_state():
    ...
    animator, clock = make_animator()
    animator.sprite_path("p1", "KW", ANIMATION_IDLE)  # frame 1 at t=0
...
def test_frame_loops_back_to_one_after_a_full_cycle_in_a_looping_state():
    ...
    animator, clock = make_animator()
    animator.sprite_path("p1", "KW", ANIMATION_IDLE)
...
def test_frame_freezes_on_the_last_frame_for_a_non_looping_state():
    ...
    animator, clock = make_animator()
    animator.sprite_path("p1", "KW", ANIMATION_JUMP)
...
def test_each_piece_id_tracks_its_own_animation_clock_independently():
    animator, clock = make_animator()
    animator.sprite_path("piece-a", "KW", ANIMATION_IDLE)  # enters idle at t=0

    clock.now = 0.2  # 1 frame in for piece-a
    animator.sprite_path("piece-b", "KW", ANIMATION_IDLE)  # piece-b enters idle now, at t=0.2

    path_a = animator.sprite_path("piece-a", "KW", ANIMATION_IDLE)
    path_b = animator.sprite_path("piece-b", "KW", ANIMATION_IDLE)
